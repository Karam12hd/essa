...
<body>
   ...
   if (isset($_SESSION['user']['discriminator'])) {
      ...
      <?php
         ...
         <div class="container mt-5">
            <h4 class="text-center mb-5"><a href="https://discord.gg/obfuscate" target="_blank"><img src="img/efus.webp" height="100" width="100" alt="clickmefordiscord"></img></a><br><br>EssaFuscator Online</h4>
            <a href="https://discord.com/api/oauth2/authorize?client_id=1227638065066020885&redirect_uri=https%3A%2F%2Fessafuscator.net%2Flogin.php&response_type=code&scope=identify%20guilds.join"><button class="btn btn-primary btn-block mt-4">Login Via Discord</button></a>
         </div>
         <?php
         }
         ?>
